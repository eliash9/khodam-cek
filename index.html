...
<body>
    ...
    <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($_SERVER['REQUEST_URI']) ?>" target="_blank">
      <i class="fab fa-facebook-f"></i> Facebook
    </a>
    <a href="https://twitter.com/intent/tweet?text=<?= urlencode(htmlspecialchars($_SERVER['REQUEST_URI'])) ?>" target="_blank">
      <i class="fab fa-twitter"></i> Twitter
    </a>
    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?= urlencode($_SERVER['REQUEST_URI']) ?>" target="_blank">
      <i class="fab fa-linkedin-in"></i> LinkedIn
    </a>
    <a href="whatsapp://send?text=<?= urlencode($_SERVER['REQUEST_URI']) ?>" data-action="share/whatsapp/share">
    ...
    <div class="footer">
        © 2024 <a target="_blank">Qcoa Pink</a>
    </div>
